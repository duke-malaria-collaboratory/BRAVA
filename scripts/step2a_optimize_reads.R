...
filt_path <- file.path(path, "filtered_final") # Place filtered files in filtered/ subdirectory
...
final_filtFs <- file.path(filt_path, paste0(sample.names, "_final_F_filt.fastq.gz"))
final_filtRs <- file.path(filt_path, paste0(sample.names, "_final_R_filt.fastq.gz"))
